...
const CONFIG_FILENAME = "athena.json";
...
/**
 * Walk up from `startDir` looking for `athena.json`.
...
/**
 * Walk up from `process.cwd()` looking for `athena.json`.
 * Returns the full path to the config file, or null if not found.
 */
 ...
 * containing `athena.json`, or null.
 */
...
/**
 * Write `athena.json` to the given directory with pretty-printed JSON.
 */
